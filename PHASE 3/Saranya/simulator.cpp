...
Specifications parseSpecifications(const std::string &filename) {
    ...
    std::cout << "\nSpecifications parsed from file:\n";
    std::cout << "Data Forwarding: " << (specs.data_forwarding ? "Enabled" : "Disabled") << std::endl;
    std::cout << "L1 Cache Size: " << specs.L1_cache_size << std::endl;
    std::cout << "L2 Cache Size: " << specs.L2_cache_size << std::endl;
    std::cout << "L1 Associativity: " << specs.L1_associativity << std::endl;
    std::cout << "L2 Associativity: " << specs.L2_associativity << std::endl;
    std::cout << "L1 Latency: " << specs.L1_latency << std::endl;
    std::cout << "L2 Latency: " << specs.L2_latency << std::endl;
    std::cout << "Main Memory Latency: " << specs.main_memory_latency << std::endl;

    std::cout << "Instruction Latencies:\n";
    for (const auto& pair : specs.latencies) {
        std::cout << "  " << pair.first << " = " << pair.second << " cycles\n";
    }
